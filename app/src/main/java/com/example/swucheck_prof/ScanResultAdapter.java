...
/**
 * Holds and displays {@link ScanResult}s, used by {@link ResultFragment}.
 */
public class ScanResultAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            view = mInflater.inflate(R.layout.liststu_scanresult, null);
        }
        ...
        byte[] bytes = scanRecord.getServiceData(Constants.Service_UUID);
